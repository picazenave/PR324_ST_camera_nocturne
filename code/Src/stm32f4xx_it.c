...
void DMA2_Stream2_IRQHandler(void)
{
  ...
  //   HT = 1;                     /* Check for data to process */
  //   HAL_UART_Transmit(&huart2,"HT UART1 \r\n",11,300);  
  // }
  ...
  //   TC = 1;                     /* Check for data to process */
  //   HAL_UART_Transmit(&huart2,"TC UART1 \r\n",11,300);  
  // }
  // HAL_UART_Transmit(&huart2,"DMA UART1 IT\r\n",14,300);
